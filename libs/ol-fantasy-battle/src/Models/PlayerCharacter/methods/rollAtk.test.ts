...
describe('PlayerCharacter.rollAtk()', () => {
  ...
  it('works', () => {
    ...
    expect(rollAtk.call(mockedPc, "Agility").diceArgs).toEqual(expect.objectContaining({ dieAmmount: 1, dieMax: 20, bonus: 3 }))
  })
  ...
  it('works with bonus arguments', () => {
    ...
    expect(rollAtk.call(mockedPc, "Entropy", { advantage: 2, bonus: -3 }).diceArgs).toEqual(expect.objectContaining({ dieAmmount: 1, dieMax: 20, advantage: 2, bonus: -5 }))
  })
})
